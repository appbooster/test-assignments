...
* Наличие интеграционных и юнит тестов
* Запуск сервера и тестов без ошибок, интуитивным или хорошо описанным способом
* Скорость ответа от сервера <100ms
* Корректная асинхронная работа
* Эндпоинты добавления и удаления новых экспериментов
